...
// output: [-64, 64] = [-1; +1]
static i32 cos_q6(i32 turn_q10)
{
    return cos_tab_[(uint)turn_q10 & 0x3FF];
}
...
// maps the angle to the first part of cos -> lookup table
static i32 _cos_q16_fast(i32 turn_q10)
{
    int i   = (uint)turn_q10 & 0x3FF;
    int neg = 0;
...
// output: [-65536, 65536] = [-1; +1]
//  maps the angle to the first part of cos -> lookup table + lerp
static i32 cos_q16(i32 turn_q18)
{
    return _cos_q16_fast(turn_q18 >> 8);
}
...
static const i8 cos_tab_[1024] = {
    ...
    +0x37, +0x37, +0x36, +0x36, +0x36, +0x36, +0x36, +0x35,
    ...
    +0x26, +0x26, +0x25, +0x25, +0x25, +0x24, +0x24, +0x24,
    +0x23, +0x23, +0x23, +0x22, +0x22, +0x22, +0x21, +0x21,
    +0x21, +0x20, +0x20, +0x20, +0x1F, +0x1F, +0x1F, +0x1E,
    +0x1E, +0x1E, +0x1D, +0x1D, +0x1C, +0x1C, +0x1C, +0x1B,
    +0x1B, +0x1B, +0x1A, +0x1A, +0x1A, +0x19, +0x19, +0x19,
    +0x18, +0x18, +0x17, +0x17, +0x17, +0x16, +0x16, +0x16,
    +0x15, +0x15, +0x14, +0x14, +0x14, +0x13, +0x13, +0x13,
    +0x12, +0x12, +0x11, +0x11, +0x11, +0x10, +0x10, +0x10,
    +0x0F, +0x0F, +0x0E, +0x0E, +0x0E, +0x0D, +0x0D, +0x0C,
    +0x0C, +0x0C, +0x0B, +0x0B, +0x0B, +0x0A, +0x0A, +0x09,
    ...
    -0x18, -0x19, -0x19, -0x19, -0x1A, -0x1A, -0x1A, -0x1B,
    -0x1B, -0x1B, -0x1C, -0x1C, -0x1C, -0x1D, -0x1D, -0x1E,
    -0x1E, -0x1E, -0x1F, -0x1F, -0x1F, -0x20, -0x20, -0x20,
    -0x21, -0x21, -0x21, -0x22, -0x22, -0x22, -0x23, -0x23,
    -0x23, -0x24, -0x24, -0x24, -0x25, -0x25, -0x25, -0x26,
    ...
    -0x33, -0x34, -0x34, -0x34, -0x34, -0x34, -0x35, -0x35,
    -0x35, -0x35, -0x36, -0x36, -0x36, -0x36, -0x36, -0x37,
