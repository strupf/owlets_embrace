...
#define LCDMakePattern(r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, ra, rb, rc, rd, re, rf)                 \
    (LCDPattern)                                                                                       \
    {                                                                                                  \
        (r0), (r1), (r2), (r3), (r4), (r5), (r6), (f7), (r8), (r9), (ra), (rb), (rc), (rd), (re), (rf) \
    }
#define LCDOpaquePattern(r0, r1, r2, r3, r4, r5, r6, r7)                                               \
    (LCDPattern)                                                                                       \
    {                                                                                                  \
        (r0), (r1), (r2), (r3), (r4), (r5), (r6), (r7), 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff \
    }
