...
RLAPI void        SetWindowState(unsigned int properties);              // Set window configuration state using flags (only PLATFORM_DESKTOP)
RLAPI void        ClearWindowState(unsigned int properties);            // Clear window configuration state flags
...
RLAPI void SetConfigFlags(unsigned int properties); // Setup init configuration flags (view FLAGS)
...
//------------------------------------------------------------------------------------
RLAPI void    SetGesturesEnabled(unsigned int properties); // Enable a set of gestures using flags
